...
soma_notas -= max(lista_notas)
soma_notas -= min(lista_notas)

print('\nResultado final:')
print(f'Atleta: {nome_atleta}')
print('Melhor nota: {:.2f}'.format(max(lista_notas)))
print('Pior nota: {:.2f}'.format(min(lista_notas)))
print('Media: {:.2f}'.format(soma_notas / 5.0))